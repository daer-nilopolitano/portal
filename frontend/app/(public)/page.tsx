  ...
  return (
    <>
      <section className="relative flex h-[420px] items-center justify-center overflow-hidden text-center md:h-[480px]">
        ...
        />
        {/* Véu na cor do DAER sobre a foto, garante contraste pro texto em qualquer trecho da montagem */}
        <div className="absolute inset-0 bg-daer-blue/70" />
        ...
        <div className="relative px-6">
          <Image
            ...
            className="mx-auto"
          />
          <h1 className="mt-4 text-4xl font-bold text-white">DAER Nilopolitano</h1>
